...
Poetry is also not introduced in this course, but it's widely used and very popular as a modern python project dependencies management tool. So, we could also consider it a best practice that's worth mentioning.
...
To create a custom Module used in Terraform we can structure project like this:
